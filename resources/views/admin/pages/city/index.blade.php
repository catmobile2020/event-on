            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <a href="{{route('admin.cities.create',$country->id)}}" class="btn btn-primary" style="float: right;">Add City</a>
                    </div>
                                        ...
                                        <td class="size-80">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{route('admin.cities.edit',[$country->id,$row->id])}}">Edit</a></li>
                                                    <li><a href="{{route('admin.cities.destroy',[$country->id,$row->id])}}">Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>

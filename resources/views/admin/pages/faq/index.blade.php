...
@section('content')
    <div class="main-content">
        ...
        <ol class="breadcrumb breadcrumb-2">
            ...
            <li class="active"><strong>Faqs</strong></li>
        </ol>
        <div class="row">
            <div class="col-lg-12">
                                        ...
                                        <td class="size-80">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{route('admin.faqs.edit',[$company->id,$row->id])}}">Edit</a></li>
                                                    <li><a href="{{route('admin.faqs.destroy',[$company->id,$row->id])}}">Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
